...
urlpatterns = [
    ...
    url(r'^block_bed/(?P<pk>[\w.@+-]+)/$', views.block_bed, name='block_bed'),

    url(r'^patient_new$', views.patient_new, name='patient_new'),

    #url(r'^confirm_patient', views.confirm_patient, name='confirm_patient'),
